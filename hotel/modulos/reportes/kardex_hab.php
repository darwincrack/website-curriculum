            ...
            <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title" align="center"><b>Kardex de Habitaciones por fecha</b></h4>                         
                             <?php 
                                    if(!empty($_POST['i'])){
                            ...
                            <div class="hidden">
                                      <hr/>
                                          <div style="font-size: 14px;"align="center">
                                             <strong>REPORTE DE KARDEX DE HABITACIONES</strong><br>                              
                                        </div> 
                                        <hr/>
                                    </div>
                            <table class="table table-striped table-bordered table-responsive" width="100%" style="font-size: 14px;"  border="0">
                                <thead>
                                    <tr>                                       
                                        <th><div align="center">Habitación y Servicios</div></th>
                                ...
                                <tbody>
                                    ...
                                    <tr>                                       
                                        ...
                                        <td align="center"><?php echo $s.formato($rr['val']); ?></td>
