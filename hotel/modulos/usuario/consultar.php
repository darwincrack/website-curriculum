  ...
  error_reporting(E_COMPILE_ERROR|E_ERROR|E_CORE_ERROR);
    ...
    if($_SESSION['tipo_user']=='a' or $_SESSION['tipo_user']=='u'){
        if(permisos($_SESSION['seguridad'.$_SESSION['cod_user']],'Usuarios','1')==true){
            ...
            header('Location: modulos/error500.php');
        }
    }else{
        header('Location: modulos/error500.php');
    }
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="cod"  required class="form-control" placeholder="Usuario para acceder al sistema" autocomplete="off" onKeyUp="this.value=this.value.toUpperCase();">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="field-2" class="control-label">Nombre</label>
                                                        <input type="text" name="nom"  required class="form-control" placeholder="Nombre de la persona" autocomplete="off" onKeyUp="this.value=this.value.toUpperCase();">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="tel"  required class="form-control" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
            ...
            <div class="container">
                            <?php
                                ...
                                if(!empty($_POST['cod']) and !empty($_POST['nom'])){
                                    ...
                                    $cel='cell';
                                    $sucursal=2; //limpiar($_POST['sucursal']);      
                                    $cargo=limpiar($_POST['cargo']);
                                    $con=md5($cod);                          
                                    $caja="RECEPCION"; //limpiar($_POST['caja']);
            ...
            <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title" align="center"><b>LISTADO DE USUARIOS</b></h4>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="field-1" class="control-label">Usuario</label>
                                                                            <input type="text" name="cod" value="<?php echo $rr['cod']; ?>" placeholder="Usuario para acceder al sistema" class="form-control" autocomplete="off" onKeyUp="this.value=this.value.toUpperCase();" readonly>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="field-2" class="control-label">Nombre</label>
                                                                            <input type="text" name="nom" value="<?php echo $rr['nom']; ?>" required class="form-control" placeholder="Nombre de la persona" autocomplete="off" onKeyUp="this.value=this.value.toUpperCase();">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="field-4" class="control-label">Telefono</label>
                                                                            <input type="text" name="tel" value="<?php echo $rr['tel']; ?>" required class="form-control" autocomplete="off">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
