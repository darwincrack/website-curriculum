                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="cod"  required  class="form-control" autocomplete="off" maxlength="13" onkeypress="return Numeros(event);">
                                                    </div>
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="form-group">
                         ...
                         <?php
                                   ...
                                   if(!empty($_POST['nom'])){
                                        ...
                                        if(empty($_POST['id'])){
                                            ...
                                            echo mensajes('Cliente "'.$nombre.'" Actualizado con Exito, con la ID '.cb($documento),'verde');
                                        }
            ...
            <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title" align="center"><b>Listado de Clientes</b></h4>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="field-1" class="control-label">N° Documento:</label>
                                                                            <input type="text" name="cod" value="<?php echo $rr['nit']; ?>" required class="form-control" autocomplete="off" maxlength="13" onkeypress="return Numeros(event);">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="field-4" class="control-label">Telefono Conv.</label>
                                                                            <input type="text" name="tel" value="<?php echo $rr['tel']; ?>" required class="form-control" onkeypress="return Numeros(event);" autocomplete="off">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="field-4" class="control-label">Celular:</label>
                                                                            <input type="text" name="cel" value="<?php echo $rr['cel']; ?>" required class="form-control" onkeypress="return Numeros(event);" autocomplete="off">
                                                                        </div>
                                                                    </div>
                                                                <!-- sucursales     <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="field-6" class="control-label">Sucursal:</label>
                                                                            <select class="form-control select2" name="sucursal" required>
                                                                                    <option>Seleccionar</option>
...
<script type="text/javascript">
    ...
    $('#liClientela').addClass("treeview active");
