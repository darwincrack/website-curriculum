        ...
        <header id="topnav">
            <div class="topbar-main">
                <div class="container">
                    ...
                    <!-- Logo container-->
                    <div class="logo">
                        <a href="../principal/" class="logo"><i class="md md-equalizer"></i> <span>Hotel PortoBello</span> </a>
                    </div>
                    <!-- End Logo container-->
            ...
            <div class="container">
                         <?php
                                   if(!empty($_POST['nom'])){ 
                                        ...
                                        if(empty($_POST['id'])){
                                            $oSucursal=new Proceso_Suscursal('',$codigo,$nombre,$direccion,$telefono,$ciudad,$distrito,$nom_imp,$val_imp,$tama,$letra);
                                            ...
                                            $id=limpiar($_POST['id']);
                                            $oSucursal=new Proceso_Suscursal($id,$codigo,$nombre,$direccion,$telefono,$ciudad,$distrito,$nom_imp,$val_imp,$tama,$letra);
