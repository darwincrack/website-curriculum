                                    ...
                                    <tr>
                                      ...
                                      <!--   <?php if(permisos($_SESSION['seguridad'.$_SESSION['cod_user']],'Recepción','1')==true){ ?>    -->                                       
                                                <div  class="btn-group btn-group m-b-10">
                                                    <a href="DetalleRecepcion.php?i=<?php echo claves($rr[0]); ?>" class="btn btn-danger btn-smm waves-effect waves-light" role="button" data-toggle="tooltip" data-placement="top" data-original-title="Asignar Habitacion" > <i class="fa fa-bed"></i></a>
                                                </div>
                                       <!--     <?php } ?>    --> 
                                        </td>
                                    </tr>
