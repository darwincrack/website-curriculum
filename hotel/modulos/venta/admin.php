...
header('Location:index.php');  
            ...
            if(!empty($_GET['c'])){
                ...
                if(!empty($_GET['p'])){
                    ...
                    $tipo_cliente = $_SESSION['tipocliente'];
                     ...
                     if ($tipo_cliente!='CONVENIO') {
                        ...
                        $val=consultar('tarifa_dia','hospedaje',"id='$id_hospedado'");
                         }
                            ...
                            <div class="panel-body">
                                <table class="table">
                                    <?php 
                                        ...
                                        $ss=mysql_query("SELECT * FROM confi WHERE tabla='categoria' and id='$categoria' ORDER BY nombre");
                        ...
                        <div class="panel panel-success panel-border">
                            ...
                            <div class="panel-body">
                                                ...
                                                //  $boton='<a href="#" class="btn btn-block btn-lg btn btn-danger waves-effect w-md waves-light m-b-5">
                                                  //          <strong>'.$rr['nombre'].'<br> OCUPADA</strong></a>';
                                                          ...
                                                          $boton='<a href="DetalleRecepcion.php?c='.claves($id_categoria).'&p='.claves($rr['id']).'" class="btn btn-block btn-lg btn btn-success waves-effect w-md waves-light m-b-5">
                                                            <strong>'.$rr['nombre'].'<br>'.$s.formato($val).'</strong></a>';
                             ...
                             <div class="table-responsive">
                                  <table class="table m-0">
                                            <tr>
                                                <td colspan="5"><strong><center>INFORMACION DE LA FACTURA</center></strong></td>
                                            </tr>
                                            <tr>
                                                <td><strong>Descripcion</strong></td>
                                                <td align="center"><strong>P.Unit</strong></td>
                                            ...
                                            <?php 
                                                ...
                                                if ($_SESSION['tipocliente']!='CONVENIO') {
                                                  $ss=mysql_query("SELECT * FROM venta_caja_tmp WHERE usu='$usuario' and id_hospedado=$id_hospedado");
                                                while($rr=mysql_fetch_array($ss)){
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                        ...
                                                        ?>
                                                        <a href="DetalleRecepcion.php?remove=<?php echo claves($rr[0]).$url; ?>" class="btn btn-icon btn-xs waves-effect waves-light btn-danger m-b-5"><i class="fa fa-remove"></i></a>
                                            ...
                                            <?php } 
                                                ...
                                                $ss=mysql_query("SELECT * FROM venta_caja_tmp vc, hospedaje h WHERE vc.usu='$usuario' and h.id=$id_hospedado and vc.id_hospedado=$id_hospedado");
                                                while($rr=mysql_fetch_array($ss)){
