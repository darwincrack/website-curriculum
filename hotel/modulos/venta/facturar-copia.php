                        ...
                        <div class="panel panel-purple panel-border">
                            ...
                            <div class="table-responsive">
                                <table class="table m-0">
                                        <?php 
                                            $n=0;
                                            $ss=mysql_query("SELECT * FROM metodopago ORDER BY nombre");
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <strong><?php echo $rr['nombre']; ?></strong></a></center>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                ...
                                <div class="table-responsive">
                                    <table class="table m-0">
                                            <tr>
                                                ...
                                                <td><strong><div align="right">Cant.</div></strong></td>
                                                
                                                <td><strong><center>Valor Unit.</center></strong></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><div align="right"><?php echo $rr['cant']; ?></div></td>
                                                
                                                <td><center><?php echo $s.formato($rr['val']); ?></center></td>
