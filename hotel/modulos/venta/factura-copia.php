...
<div id="Imprime">
                            ...
                            <table width="75%" rules="all" border="1" style="font-size:<?php echo $letra; ?>px; font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif">
                                        <tr>
                                             <td colspan="4">                                                
                                            <div align="center" style="font-size:20px"><strong>Hotel Porto Bello</strong><br></div>
                                            <div align="center"><strong>TEL: </strong>0000-0000<br></div>
                                            <div align="center"><strong>NIT: </strong>0000-000000-000-0<br></div>                                                 
                                            <div align="center"><strong>GIRO: </strong> HOTEL<br></div>                                                 
                                        ...
                                        <tr>
                                            ...
                                            <td><div align="right"><?php echo $s.formato($rr['val']*$rr['cant']); ?></div></td>
                                        </tr>
                                        <?php } ?>
                                           <tr>
                                              <td colspan="4"></td><br>
                                            ...
                                            <!--<tr>
                                              ...
                                              <td><div align="right"><strong><?php echo $s.formato($factura['subtotal']); ?></strong></div></td>
                                            </tr>-->
                                             <tr>
                                              <td colspan="3"><div align="right"><strong>IVA:</strong></div></td>
                                              <td> <div align="right"><strong><?php echo $s.formato($iva); ?></strong></div></td>
                                            </tr>
                                            <tr>
