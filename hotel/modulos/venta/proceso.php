    ...
    if(!empty($_POST['subtotal']) and !empty($_POST['neto'])){
        ...
        while($rr=mysql_fetch_array($ss)){
            ...
            if($inv=='s'){
             ...
             mysql_query("UPDATE producto SET status='OCUPADA', cliente_tmp='$nom_cliente' WHERE id='$cod' and control='s'");
        }
        if($mesa=='no'){
                  ...
                  <div class="col-lg-12">
                        <div class="panel panel-success panel-border">
                            ...
                            <div class="panel-body" align="center">
                                <a href="ticket.php?i=<?php echo claves($id_factura); ?>" target="_blank" class="btn btn-danger waves-effect waves-light btn-lg m-b-5"><i class="fa fa-print m-r-5"></i> <strong>Imprimir Liquidacion de S. </strong></a><br><br>
								<a href="facturas.php?i=<?php echo claves($id_factura); ?>" target="_blank" style="width:20%" class="btn btn-success waves-effect waves-light btn-lg m-b-5"><i class="fa fa-print m-r-5"></i> <strong>Imprimir Factura </strong></a><br><br>

                                                <a href="../../Hospedaje.php" style="width:20%" class="btn btn-default waves-effect w-md waves-light m-b-5"><strong>Cerrar</strong></a>
